...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PB1     ------> ADC1_IN9
    */
    HAL_GPIO_DeInit(GPIOA, ST_ANGLE_Pin|BRK_PRESS_Pin);

    HAL_GPIO_DeInit(GPIOB, SUSP_R_Pin|SUSP_L_Pin);
...
void HAL_CAN_MspDeInit(CAN_HandleTypeDef* hcan)
{
  if(hcan->Instance==CAN1)
  {
    ...
    PA12     ------> CAN1_TX
    */
    HAL_GPIO_DeInit(GPIOA, GPIO_PIN_11|CH1_TX_Pin);
  ...
  else if(hcan->Instance==CAN2)
  {
    ...
    PB13     ------> CAN2_TX
    */
    HAL_GPIO_DeInit(GPIOB, CH2_RX_Pin|CH2_TX_Pin);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  if(htim_base->Instance==TIM13)
  {
    ...
    PA6     ------> TIM13_CH1
    */
    HAL_GPIO_DeInit(SPEED_L_GPIO_Port, SPEED_L_Pin);
  ...
  else if(htim_base->Instance==TIM14)
  {
    ...
    PA7     ------> TIM14_CH1
    */
    HAL_GPIO_DeInit(SPEED_R_GPIO_Port, SPEED_R_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==USART1)
  {
    ...
    PA10     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOA, BL_TX_Pin|BL_RX_Pin);
